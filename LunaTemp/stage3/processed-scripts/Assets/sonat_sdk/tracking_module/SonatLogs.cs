...
namespace Sonat
{
    ...
    [Serializable]
    public abstract class SonatLogLevelStartEndBase : SonatLogBasic
    {
        public int phase;
        ...
        protected virtual string SetUserPropertyLevel
        {
            get
            {
                if (phase < 1)
        ...
        protected virtual string ParameterLevelValue => SetUserPropertyLevel;
    }

    [Serializable]
    public class SonatCompleteSceneTime : SonatLogBasic
    {
        ...
        protected override List<LogParameter> GetParameters()
        {
            ...
            parameters.Add(new LogParameter(ParameterEnum.placement.ToString(), millisecond));
    ...
    [Serializable]
    public class SonatAppSpentTime: SonatLogBasic
    {
        public string placement;
        public int millisecond;
        protected override List<LogParameter> GetParameters()
...
//            AppsFlyer.sendEvent(EventName, dict);
    ...
    public class SonatLogEarnVirtualCurrency : BaseSonatAnalyticLog
    {
        ...
        public string virtual_currency_id;
        public int value;
        public string placement;
        ...
        protected override List<LogParameter> GetParameters()
        {
            ...
            parameters.Add(new LogParameter(ParameterEnum.virtual_currency_id.ToString(), virtual_currency_id));
    ...
    [Serializable]
    public class SonatLogShowUi : BaseSonatAnalyticLog
    {
    ...
    [Serializable]
    public class SonatLogOpenShop : BaseSonatAnalyticLog
    {
    ...
    [Serializable]
    public class SonatLogCancelShopItem : BaseSonatAnalyticLog
    {
    ...
    [Serializable]
    public class SonatLogViewShopItem : BaseSonatAnalyticLog
    {
    ...
    [Serializable]
    public class SonatLogBuyShopItem : BaseSonatAnalyticLog
    {
