...
public class BB10_BrickCubeUnit : MonoBehaviour
{
    ...
    public void SetSprite([Bridge.Ref] BB10_ColorData data)
    {
        myData = data;
    ...
    public void MoveCenterPos([Bridge.Ref] Vector2 pos, [Bridge.Ref] Vector2 center)
    {
    ...
    public void DropDown([Bridge.Ref] Vector2 startPos, [Bridge.Ref] Vector2 targetPos, float durationMove)
    {
        StartCoroutine(StartDrop(startPos, targetPos, durationMove));
    }

    IEnumerator StartDrop([Bridge.Ref] Vector2 startPos, [Bridge.Ref] Vector2 targetPos, float durationMove)
    {
        float timer = 0;
