                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 9: {
                                    UnityEngine.Debug.Log$1("Wait game over");
...
if ( TRACE ) { TRACE( "BB10_BrickCubeUnit#OnClickBlock", this ); }
                ...
                UnityEngine.Debug.Log$1("Click Block");
...
if ( TRACE ) { TRACE( "BB10_Grid#InvalidPoint", this ); }
                ...
                for (var i = 0; i < listUnit.Count; i = (i + 1) | 0) {
                    ...
                    if (this.grid == null) {
                        UnityEngine.Debug.LogError$2("Grid ch\u01b0a \u0111\u01b0\u1ee3c kh\u1edfi t\u1ea1o!");
                        return true;
                    }
...
if ( TRACE ) { TRACE( "BB10_Grid#LoadDataSave", this ); }
                ...
                var $t;
                var save = BB10_Settings.GetContinueData;
                ...
                for (var row = 0; row < this.numberRow; row = (row + 1) | 0) {
                    for (var col = 0; col < this.numberCol; col = (col + 1) | 0) {
                        ...
                        if (number === 0) {
                            ...
                            this.grid.set([row, col], this.pattemCreater.CreateABlock(new pc.Vec2( col, row ), 1));
                            this.grid.get([row, col]).SetSprite(this.colorCtr.GetSpriteData(((number - 1) | 0)));
                            this.grid.get([row, col]).row = row;
                            this.grid.get([row, col]).col = col;
                        }
                        count = (count + 1) | 0;
                    }
                ...
                for (var i = 0; i < 3; i = (i + 1) | 0) {
                    if (!Bridge.referenceEquals(wordsTotal[((2 + i) | 0)], "")) {
                        ...
                        next.SetPattem(listUnit, type, System.Int32.parse(wordsPattem[1]));
                        next.SetPattem(listUnit, type, UnityEngine.Random.Range(0, 4)); // int.Parse(wordsPattem[1]));
                        next.FixCenterPos();
...
if ( TRACE ) { TRACE( "BB10_MainObjControl#Preload", this ); }
                ...
                UnityEngine.Debug.Log$1("PATTERN CREATED");
                this.grid.Preload();
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    UnityEngine.Debug.Log(Bridge.box(BB10_MainState.typePlay, BB10_MainState.TypePlay, System.Enum.toStringFn(BB10_MainState.TypePlay)));
                                        $enumerator.current = null;
                                        $step = 1;
                                        return true;
                                }
...
if ( TRACE ) { TRACE( "BB10_NextViewer#init", this ); }
        ...
        methods: {
            ...
            SetPattem: function (listUnit, type, numberRotate) {
...
if ( TRACE ) { TRACE( "BB10_NextViewer#ClickPattern", this ); }
                ...
                UnityEngine.Debug.Log$1("Click Pattern index = " + this.index);
...
if ( TRACE ) { TRACE( "BB10_PlaneView#SetPattem", this ); }
                ...
                UnityEngine.Debug.Log$1("SetPattem");
...
if ( TRACE ) { TRACE( "BB10_PlaneView#CheckSelectedBlock", this ); }
                ...
                if (this.groundAcepted && !this.isScaling) {
                    ...
                    UnityEngine.Debug.Log$1("Quay l\u1ea1i");
                ...
                UnityEngine.Debug.Log$1("groundAcepted" + System.Boolean.toString(this.groundAcepted));
                UnityEngine.Debug.Log$1("isScaling" + System.Boolean.toString(this.isScaling));
            },
...
if ( TRACE ) { TRACE( "BB10_PlaneView#CheckGround", this ); }
                ...
                UnityEngine.Debug.Log$1("CheckGround: " + System.Boolean.toString(this.groundAcepted));
            },
...
if ( TRACE ) { TRACE( "BB10_PlaneView#IsInvalidGrid", this ); }
                ...
                if (BB10_MainState.typePlay === BB10_MainState.TypePlay.Tutorial) {
                    ...
                    UnityEngine.Debug.Log$1("Normal");
...
if ( TRACE ) { TRACE( "Vec2#Print", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","System.Collections","UnityEngine.UI","UnityEngine","System.Collections.Generic","UnityEngine.EventSystems","UnityEngine.Events","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*BB10_MainObjControl start.*/
    $m("BB10_MainObjControl", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[1].IEnumerator},{"a":2,"n":"Instant","is":true,"t":16,"rt":BB10_MainObjControl,"g":{"a":2,"n":"get_Instant","t":8,"rt":BB10_MainObjControl,"fg":"Instant","is":true},"fn":"Instant"},{"a":2,"n":"cam","t":4,"rt":CameraScript,"sn":"cam"},{"a":2,"n":"camScript","t":4,"rt":CameraScript,"sn":"camScript"},{"a":2,"n":"colorControl","t":4,"rt":BB10_ColorControl,"sn":"colorControl"},{"a":2,"n":"grid","t":4,"rt":BB10_Grid,"sn":"grid"},{"a":2,"n":"groundView","t":4,"rt":BB10_GroundView,"sn":"groundView"},{"a":2,"n":"helpCtr","t":4,"rt":BB10_ShowHelpCtr,"sn":"helpCtr"},{"a":1,"n":"main","is":true,"t":4,"rt":BB10_MainObjControl,"sn":"main"},{"a":2,"n":"nextViewerCtr","t":4,"rt":BB10_NextViewerControl,"sn":"nextViewerCtr"},{"a":2,"n":"pattemCreater","t":4,"rt":BB10_PattemCreater,"sn":"pattemCreater"},{"a":2,"n":"planeViewCrt","t":4,"rt":BB10_PlaneView,"sn":"planeViewCrt"},{"a":2,"n":"scoreCtr","t":4,"rt":BB10_ScoreCtr,"sn":"scoreCtr"},{"a":2,"n":"screenCtr","t":4,"rt":BB10_ScreenCtr,"sn":"screenCtr"},{"a":2,"n":"tutorial","t":4,"rt":BB10_Tutorial,"sn":"tutorial"}]}; }, $n);
    /*BB10_MainObjControl end.*/

    /*AddSelectItem start.*/
    $m("AddSelectItem", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"AddItem","t":8,"sn":"AddItem","rt":$n[0].Void},{"a":2,"n":"CreateTable","t":8,"sn":"CreateTable","rt":$n[0].Void},{"a":2,"n":"col","t":4,"rt":$n[0].Int32,"sn":"col","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"count","t":4,"rt":$n[0].Int32,"sn":"count","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"grid","t":4,"rt":$n[2].GridLayoutGroup,"sn":"grid"},{"a":2,"n":"height","t":4,"rt":$n[0].Single,"sn":"height","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"item","t":4,"rt":$n[3].GameObject,"sn":"item"},{"a":2,"n":"listUnit","t":4,"rt":System.Array.type(ItemUnit),"sn":"listUnit"},{"a":2,"n":"rec","t":4,"rt":$n[3].RectTransform,"sn":"rec"},{"a":2,"n":"row","t":4,"rt":$n[0].Int32,"sn":"row","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*AddSelectItem end.*/

    /*AutoPlay start.*/
    $m("AutoPlay", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"InitAuto","t":8,"sn":"InitAuto","rt":$n[1].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"StartAuto","t":8,"sn":"StartAuto","rt":$n[1].IEnumerator},{"a":1,"n":"grid","t":4,"rt":BB10_Grid,"sn":"grid"},{"a":1,"n":"nextViewerCtr","t":4,"rt":BB10_NextViewerControl,"sn":"nextViewerCtr"},{"a":1,"n":"planeView","t":4,"rt":BB10_PlaneView,"sn":"planeView"},{"a":2,"n":"timeScale","t":4,"rt":$n[0].Int32,"sn":"timeScale","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*AutoPlay end.*/

    /*BB10_BrickCubeUnit start.*/
    $m("BB10_BrickCubeUnit", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ApplyRotate","t":8,"sn":"ApplyRotate","rt":$n[0].Void},{"a":2,"n":"DropDown","t":8,"pi":[{"n":"startPos","pt":$n[3].Vector2,"ps":0},{"n":"targetPos","pt":$n[3].Vector2,"ps":1},{"n":"durationMove","pt":$n[0].Single,"ps":2}],"sn":"DropDown","rt":$n[0].Void,"p":[$n[3].Vector2,$n[3].Vector2,$n[0].Single]},{"a":2,"n":"Effect","t":8,"sn":"Effect","rt":$n[0].Void},{"a":1,"n":"EffectHideBlock","t":8,"sn":"EffectHideBlock","rt":$n[1].IEnumerator},{"a":2,"n":"MoveCenterPos","t":8,"pi":[{"n":"pos","pt":$n[3].Vector2,"ps":0},{"n":"center","pt":$n[3].Vector2,"ps":1}],"sn":"MoveCenterPos","rt":$n[0].Void,"p":[$n[3].Vector2,$n[3].Vector2]},{"a":1,"n":"OnClickBlock","t":8,"sn":"OnClickBlock","rt":$n[0].Void},{"a":2,"n":"RotateUnit","t":8,"sn":"RotateUnit","rt":$n[0].Void},{"a":2,"n":"SetAlpha","t":8,"pi":[{"n":"alpha","pt":$n[0].Single,"ps":0}],"sn":"SetAlpha","rt":$n[0].Void,"p":[$n[0].Single]},{"a":2,"n":"SetLayer","t":8,"pi":[{"n":"layer","pt":$n[0].Int32,"ps":0}],"sn":"SetLayer","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"SetShadowDropBlock","t":8,"pi":[{"n":"enable","pt":$n[0].Boolean,"ps":0}],"sn":"SetShadowDropBlock","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetSprite","t":8,"pi":[{"n":"data","pt":BB10_ColorData,"ps":0}],"sn":"SetSprite","rt":$n[0].Void,"p":[BB10_ColorData]},{"a":2,"n":"SetSprite","t":8,"pi":[{"n":"sprite","pt":$n[3].Sprite,"ps":0}],"sn":"SetSprite$1","rt":$n[0].Void,"p":[$n[3].Sprite]},{"a":1,"n":"StartDrop","t":8,"pi":[{"n":"startPos","pt":$n[3].Vector2,"ps":0},{"n":"targetPos","pt":$n[3].Vector2,"ps":1},{"n":"durationMove","pt":$n[0].Single,"ps":2}],"sn":"StartDrop","rt":$n[1].IEnumerator,"p":[$n[3].Vector2,$n[3].Vector2,$n[0].Single]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"WaitEffect","t":8,"sn":"WaitEffect","rt":$n[1].IEnumerator},{"a":2,"n":"GetObj","t":16,"rt":$n[3].GameObject,"g":{"a":2,"n":"get_GetObj","t":8,"rt":$n[3].GameObject,"fg":"GetObj"},"fn":"GetObj"},{"a":2,"n":"GetSpriteID","t":16,"rt":$n[0].Int32,"g":{"a":2,"n":"get_GetSpriteID","t":8,"rt":$n[0].Int32,"fg":"GetSpriteID","box":function ($v) { return Bridge.box($v, System.Int32);}},"fn":"GetSpriteID"},{"a":2,"n":"ID","t":4,"rt":$n[0].Int32,"sn":"ID","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"ac","t":4,"rt":pc.AnimationCurve,"sn":"ac"},{"a":2,"n":"col","t":4,"rt":$n[0].Int32,"sn":"col","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"dropScaleMin","t":4,"rt":$n[3].Vector3,"sn":"dropScaleMin"},{"a":2,"n":"durationDrop","t":4,"rt":$n[0].Single,"sn":"durationDrop","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationScaleEffect","t":4,"rt":$n[0].Single,"sn":"durationScaleEffect","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"indexCol","t":4,"rt":$n[0].Int32,"sn":"indexCol","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"indexRow","t":4,"rt":$n[0].Int32,"sn":"indexRow","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"myData","t":4,"rt":BB10_ColorData,"sn":"myData"},{"a":2,"n":"render","t":4,"rt":$n[3].SpriteRenderer,"sn":"render"},{"a":2,"n":"row","t":4,"rt":$n[0].Int32,"sn":"row","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"scale","t":4,"rt":$n[0].Single,"sn":"scale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"shadowDropBlock","t":4,"rt":$n[3].GameObject,"sn":"shadowDropBlock"},{"a":2,"n":"speed","t":4,"rt":$n[0].Single,"sn":"speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"speedRotate","t":4,"rt":$n[0].Single,"sn":"speedRotate","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"targetGray","t":4,"rt":$n[0].Single,"sn":"targetGray","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"targetScale","t":4,"rt":$n[0].Single,"sn":"targetScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"thisType","t":4,"rt":Types,"sn":"thisType","box":function ($v) { return Bridge.box($v, Types, System.Enum.toStringFn(Types));}},{"a":2,"n":"viewer","t":4,"rt":BB10_NextViewer,"sn":"viewer"}]}; }, $n);
    /*BB10_BrickCubeUnit end.*/

    /*BB10_ColorControl start.*/
    $m("BB10_ColorControl", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"CreateSprite","t":8,"pi":[{"n":"texture","pt":$n[3].Texture2D,"ps":0},{"n":"t","pt":$n[0].Single,"ps":1}],"sn":"CreateSprite","rt":$n[3].Sprite,"p":[$n[3].Texture2D,$n[0].Single]},{"a":2,"n":"GetNextSpriteData","t":8,"sn":"GetNextSpriteData","rt":BB10_ColorData},{"a":2,"n":"GetRandSpriteData","t":8,"sn":"GetRandSpriteData","rt":BB10_ColorData},{"a":2,"n":"GetSprite","t":8,"pi":[{"n":"ID","pt":$n[0].Int32,"ps":0},{"n":"t","pt":$n[0].Single,"ps":1}],"sn":"GetSprite","rt":$n[3].Sprite,"p":[$n[0].Int32,$n[0].Single]},{"a":2,"n":"GetSpriteData","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"GetSpriteData","rt":BB10_ColorData,"p":[$n[0].Int32]},{"a":2,"n":"GrayscaleSprites","t":8,"pi":[{"n":"t","pt":$n[0].Single,"ps":0}],"sn":"GrayscaleSprites","rt":System.Array.type(UnityEngine.Sprite),"p":[$n[0].Single]},{"a":1,"n":"SettupTexture","t":8,"sn":"SettupTexture","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"count","t":4,"rt":$n[0].Int32,"sn":"count","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"height","t":4,"rt":$n[0].Int32,"sn":"height","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"pixelsPerUnit","t":4,"rt":$n[0].Single,"sn":"pixelsPerUnit","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"preload","t":4,"rt":$n[0].Int32,"sn":"preload","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"preloadSprite","t":4,"rt":System.Array.type(System.Array.type(UnityEngine.Sprite)),"sn":"preloadSprite"},{"a":2,"n":"spriteTexs","t":4,"rt":System.Array.type(UnityEngine.Texture2D),"sn":"spriteTexs"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":2,"n":"sprites","t":4,"rt":System.Array.type(BB10_ColorData),"sn":"sprites"},{"a":1,"n":"width","t":4,"rt":$n[0].Int32,"sn":"width","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*BB10_ColorControl end.*/

    /*BB10_ColorData start.*/
    $m("BB10_ColorData", function () { return {"att":1057033,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ID","t":4,"rt":$n[0].Int32,"sn":"ID","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":2,"n":"sprite","t":4,"rt":$n[3].Sprite,"sn":"sprite"}]}; }, $n);
    /*BB10_ColorData end.*/

    /*BB10_Grid start.*/
    $m("BB10_Grid", function () { return {"nested":[BB10_Grid.fillData,BB10_Grid.unitWait],"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"CenterOfList","t":8,"pi":[{"n":"listFill","pt":$n[4].List$1(UnityEngine.Vector2),"ps":0}],"sn":"CenterOfList","rt":$n[3].Vector2,"p":[$n[4].List$1(UnityEngine.Vector2)]},{"a":2,"n":"ChangeSpriteFillCol","t":8,"pi":[{"n":"col","pt":$n[0].Int32,"ps":0},{"n":"data","pt":BB10_ColorData,"ps":1}],"sn":"ChangeSpriteFillCol","rt":$n[0].Void,"p":[$n[0].Int32,BB10_ColorData]},{"a":2,"n":"ChangeSpriteFillRow","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"data","pt":BB10_ColorData,"ps":1}],"sn":"ChangeSpriteFillRow","rt":$n[0].Void,"p":[$n[0].Int32,BB10_ColorData]},{"a":1,"n":"CheckBundle","t":8,"sn":"CheckBundle","rt":$n[0].Void},{"a":2,"n":"CheckGrid","t":8,"pi":[{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"isCollect","ref":true,"pt":$n[0].Boolean,"ps":1}],"sn":"CheckGrid","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),$n[0].Boolean]},{"a":2,"n":"CheckGridFillTest","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"mainRow","pt":$n[0].Int32,"ps":1},{"n":"mainCol","pt":$n[0].Int32,"ps":2},{"n":"data","pt":BB10_ColorData,"ps":3}],"sn":"CheckGridFillTest","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32,BB10_ColorData]},{"a":2,"n":"ClearListFill","t":8,"sn":"ClearListFill","rt":$n[0].Void},{"a":1,"n":"DeleteList","t":8,"pi":[{"n":"newCubeUnitWait","pt":$n[4].List$1(BB10_Grid.unitWait),"ps":0}],"sn":"DeleteList","rt":$n[1].IEnumerator,"p":[$n[4].List$1(BB10_Grid.unitWait)]},{"a":1,"n":"DeleteListEffect","t":8,"pi":[{"n":"listBlockDelete","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0}],"sn":"DeleteListEffect","rt":$n[1].IEnumerator,"p":[$n[4].List$1(BB10_BrickCubeUnit)]},{"a":1,"n":"DeleteOneCol","t":8,"pi":[{"n":"col","pt":$n[0].Int32,"ps":0},{"n":"thisRow","pt":$n[0].Int32,"ps":1},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":2},{"n":"isUp","pt":$n[0].Boolean,"ps":3}],"sn":"DeleteOneCol","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[0].Boolean]},{"a":1,"n":"DeleteOneRow","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"thisCol","pt":$n[0].Int32,"ps":1},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":2},{"n":"isUp","pt":$n[0].Boolean,"ps":3}],"sn":"DeleteOneRow","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[0].Boolean]},{"a":2,"n":"DeleteSomeBlock","t":8,"sn":"DeleteSomeBlock","rt":$n[0].Void},{"a":1,"n":"GetOneInCol","t":8,"pi":[{"n":"c","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1}],"sn":"GetOneInCol","rt":BB10_BrickCubeUnit,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)]},{"a":1,"n":"GetOneInRow","t":8,"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1}],"sn":"GetOneInRow","rt":BB10_BrickCubeUnit,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)]},{"a":2,"n":"GetPlacePattem","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0}],"sn":"GetPlacePattem","rt":Vec2,"p":[$n[4].List$1(BB10_BrickCubeUnit)]},{"a":1,"n":"GetRandGray","t":8,"sn":"GetRandGray","rt":$n[0].Single,"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"GrayBlock","t":8,"pi":[{"n":"unit","pt":BB10_BrickCubeUnit,"ps":0},{"n":"targetGray","pt":$n[0].Single,"ps":1},{"n":"isGrayIn","pt":$n[0].Boolean,"ps":2}],"sn":"GrayBlock","rt":$n[1].IEnumerator,"p":[BB10_BrickCubeUnit,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"GrayScaleMap","t":8,"pi":[{"n":"isGrayIn","pt":$n[0].Boolean,"ps":0}],"sn":"GrayScaleMap","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"InvalidPlacePattem","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0}],"sn":"InvalidPlacePattem","rt":$n[0].Boolean,"p":[$n[4].List$1(BB10_BrickCubeUnit)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"InvalidPoint","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"row","pt":$n[0].Int32,"ps":1},{"n":"col","pt":$n[0].Int32,"ps":2}],"sn":"InvalidPoint","rt":$n[0].Boolean,"p":[$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"IsColFillWith","t":8,"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"c","pt":$n[0].Int32,"ps":1}],"sn":"IsColFillWith","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"IsInList","t":8,"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"c","pt":$n[0].Int32,"ps":1},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":2}],"sn":"IsInList","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"IsInListInt","t":8,"pi":[{"n":"value","pt":$n[0].Int32,"ps":0},{"n":"listInt","pt":$n[4].List$1(System.Int32),"ps":1}],"sn":"IsInListInt","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[4].List$1(System.Int32)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"IsInListTest","t":8,"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"c","pt":$n[0].Int32,"ps":1},{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":2},{"n":"mainRow","pt":$n[0].Int32,"ps":3},{"n":"mainCol","pt":$n[0].Int32,"ps":4}],"sn":"IsInListTest","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"IsRowFillWith","t":8,"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"c","pt":$n[0].Int32,"ps":1}],"sn":"IsRowFillWith","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"LoadDataSave","t":8,"sn":"LoadDataSave","rt":$n[0].Void},{"a":2,"n":"PosValidPattem","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0}],"sn":"PosValidPattem","rt":$n[3].Vector2,"p":[$n[4].List$1(BB10_BrickCubeUnit)]},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":1,"n":"SaveData","t":8,"sn":"SaveData","rt":$n[0].Void},{"a":2,"n":"SetAllBlock","t":8,"sn":"SetAllBlock","rt":$n[0].Void},{"a":1,"n":"StartGrayScale","t":8,"pi":[{"n":"isGrayIn","pt":$n[0].Boolean,"ps":0}],"sn":"StartGrayScale","rt":$n[1].IEnumerator,"p":[$n[0].Boolean]},{"a":2,"n":"TurnOffAllFillLine","t":8,"sn":"TurnOffAllFillLine","rt":$n[0].Void},{"a":2,"n":"ValidPlaceMoreThanOne","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0}],"sn":"ValidPlaceMoreThanOne","rt":$n[0].Boolean,"p":[$n[4].List$1(BB10_BrickCubeUnit)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"deleteCol","t":8,"pi":[{"n":"col","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1}],"sn":"deleteCol","rt":$n[0].Void,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)]},{"a":1,"n":"deleteRow","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1}],"sn":"deleteRow","rt":$n[0].Void,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)]},{"a":2,"n":"insideBorder","t":8,"pi":[{"n":"cubeUnit","pt":BB10_BrickCubeUnit,"ps":0}],"sn":"insideBorder","rt":$n[0].Int32,"p":[BB10_BrickCubeUnit],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"isColFull","t":8,"pi":[{"n":"col","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1}],"sn":"isColFull","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isColFullTest","t":8,"pi":[{"n":"col","pt":$n[0].Int32,"ps":0},{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1},{"n":"mainRow","pt":$n[0].Int32,"ps":2},{"n":"mainCol","pt":$n[0].Int32,"ps":3}],"sn":"isColFullTest","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isRowFull","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"newCubeUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1},{"n":"listColDeleted","pt":$n[4].List$1(System.Int32),"ps":2}],"sn":"isRowFull","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[4].List$1(System.Int32)],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isRowFullTest","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":1},{"n":"mainRow","pt":$n[0].Int32,"ps":2},{"n":"mainCol","pt":$n[0].Int32,"ps":3}],"sn":"isRowFullTest","rt":$n[0].Boolean,"p":[$n[0].Int32,$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"colorCtr","t":4,"rt":BB10_ColorControl,"sn":"colorCtr"},{"a":2,"n":"durationGray","t":4,"rt":$n[0].Single,"sn":"durationGray","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"fullGray","t":4,"rt":$n[0].Single,"sn":"fullGray","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"grid","t":4,"rt":System.Array.type(BB10_BrickCubeUnit, 2),"sn":"grid"},{"a":2,"n":"gridPos","t":4,"rt":System.Array.type(UnityEngine.Vector2, 2),"sn":"gridPos"},{"a":2,"n":"halfGray","t":4,"rt":$n[0].Single,"sn":"halfGray","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"listFill","t":4,"rt":$n[4].List$1(BB10_Grid.fillData),"sn":"listFill"},{"a":2,"n":"nonGray","t":4,"rt":$n[0].Single,"sn":"nonGray","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"numberCol","t":4,"rt":$n[0].Int32,"sn":"numberCol","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"numberRow","t":4,"rt":$n[0].Int32,"sn":"numberRow","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"pattemCreater","t":4,"rt":BB10_PattemCreater,"sn":"pattemCreater"},{"a":2,"n":"waitDelete","t":4,"rt":$n[0].Single,"sn":"waitDelete","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"waitPerUnit","t":4,"rt":$n[0].Single,"sn":"waitPerUnit","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"waitUnit","t":4,"rt":$n[0].Single,"sn":"waitUnit","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BB10_Grid end.*/
    ...
    /*BB10_GroundView start.*/
    $m("BB10_GroundView", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"GetCube","t":8,"sn":"GetCube","rt":$n[3].SpriteRenderer},{"a":2,"n":"HideAllBlock","t":8,"sn":"HideAllBlock","rt":$n[0].Void},{"a":2,"n":"SetPattem","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"row","pt":$n[0].Int32,"ps":1},{"n":"col","pt":$n[0].Int32,"ps":2},{"n":"data","pt":BB10_ColorData,"ps":3}],"sn":"SetPattem","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),$n[0].Int32,$n[0].Int32,BB10_ColorData]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"ID","t":4,"rt":$n[0].Int32,"sn":"ID","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"groundPrefab","t":4,"rt":$n[3].GameObject,"sn":"groundPrefab"},{"a":2,"n":"listBlockRender","t":4,"rt":$n[4].List$1(UnityEngine.SpriteRenderer),"sn":"listBlockRender"},{"a":1,"n":"vecDown","t":4,"rt":$n[3].Vector3,"sn":"vecDown"}]}; }, $n);
    /*BB10_GroundView end.*/

    /*BB10_NextViewer start.*/
    $m("BB10_NextViewer", function () { return {"nested":[BB10_NextViewer.State],"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"CheckImpossible","t":8,"sn":"CheckImpossible","rt":$n[0].Void},{"a":2,"n":"ClickPattern","t":8,"sn":"ClickPattern","rt":$n[0].Void},{"a":2,"n":"FixCenterPos","t":8,"sn":"FixCenterPos","rt":$n[0].Void},{"a":2,"n":"GreyWhenGameOver","t":8,"sn":"GreyWhenGameOver","rt":$n[0].Void},{"a":2,"n":"HideAllBlock","t":8,"sn":"HideAllBlock","rt":$n[0].Void},{"a":1,"n":"MoveBlocks","t":8,"sn":"MoveBlocks","rt":$n[1].IEnumerator},{"a":2,"n":"PosValid","t":8,"sn":"PosValid","rt":$n[3].Vector2},{"a":2,"n":"RotatePattem","t":8,"pi":[{"n":"numberRotate","pt":$n[0].Int32,"ps":0}],"sn":"RotatePattem","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"RotatePattemOne","t":8,"sn":"RotatePattemOne","rt":$n[0].Void},{"a":2,"n":"SetAllBlock","t":8,"sn":"SetAllBlock","rt":$n[0].Void},{"a":1,"n":"SetBlockPos","t":8,"pi":[{"n":"pos","pt":$n[3].Vector2,"ps":0}],"sn":"SetBlockPos","rt":$n[0].Void,"p":[$n[3].Vector2]},{"a":1,"n":"SetLight","t":8,"pi":[{"n":"alpha","pt":$n[0].Single,"ps":0}],"sn":"SetLight","rt":$n[0].Void,"p":[$n[0].Single]},{"a":2,"n":"SetPattem","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"type","pt":Types,"ps":1},{"n":"numberRotate","pt":$n[0].Int32,"ps":2}],"sn":"SetPattem","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),Types,$n[0].Int32]},{"a":2,"n":"SetPattemAndRotate","t":8,"pi":[{"n":"listUnit","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"type","pt":Types,"ps":1}],"sn":"SetPattemAndRotate","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),Types]},{"a":2,"n":"ShowAllBlock","t":8,"sn":"ShowAllBlock","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"StartSetLight","t":8,"pi":[{"n":"fromAlpha","pt":$n[0].Single,"ps":0},{"n":"toAlpha","pt":$n[0].Single,"ps":1}],"sn":"StartSetLight","rt":$n[1].IEnumerator,"p":[$n[0].Single,$n[0].Single]},{"a":2,"n":"ValidMoreThanOne","t":8,"sn":"ValidMoreThanOne","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"ScaleUpAnim","t":4,"rt":$n[1].IEnumerator,"sn":"ScaleUpAnim"},{"a":2,"n":"ac1","t":4,"rt":pc.AnimationCurve,"sn":"ac1"},{"a":2,"n":"ac2","t":4,"rt":pc.AnimationCurve,"sn":"ac2"},{"a":2,"n":"duration","t":4,"rt":$n[0].Single,"sn":"duration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationIn","t":4,"rt":$n[0].Single,"sn":"durationIn","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationLight","t":4,"rt":$n[0].Single,"sn":"durationLight","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"index","t":4,"rt":$n[0].Int32,"sn":"index","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"isMoving","t":4,"rt":$n[0].Boolean,"sn":"isMoving","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"listBlock","t":4,"rt":$n[4].List$1(BB10_BrickCubeUnit),"sn":"listBlock"},{"a":1,"n":"listBlockLocalPos","t":4,"rt":System.Array.type(UnityEngine.Vector2),"sn":"listBlockLocalPos"},{"a":2,"n":"myType","t":4,"rt":Types,"sn":"myType","box":function ($v) { return Bridge.box($v, Types, System.Enum.toStringFn(Types));}},{"a":1,"n":"normalPos","t":4,"rt":$n[3].Vector2,"sn":"normalPos"},{"a":2,"n":"rotateTime","t":4,"rt":$n[0].Int32,"sn":"rotateTime","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"scale","t":4,"rt":$n[0].Single,"sn":"scale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"startPos1","t":4,"rt":$n[3].Vector2,"sn":"startPos1"},{"a":2,"n":"startPos2","t":4,"rt":$n[3].Vector2,"sn":"startPos2"},{"a":2,"n":"state","t":4,"rt":BB10_NextViewer.State,"sn":"state","box":function ($v) { return Bridge.box($v, BB10_NextViewer.State, System.Enum.toStringFn(BB10_NextViewer.State));}}]}; }, $n);
    /*BB10_NextViewer end.*/
    ...
    /*BB10_ScoreCtr start.*/
    $m("BB10_ScoreCtr", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"FadeOut","t":8,"pi":[{"n":"text","pt":$n[3].TextMesh,"ps":0}],"sn":"FadeOut","rt":$n[1].IEnumerator,"p":[$n[3].TextMesh]},{"a":2,"n":"GetText","t":8,"sn":"GetText","rt":$n[3].TextMesh},{"a":1,"n":"GetY","t":8,"pi":[{"n":"t","pt":$n[0].Single,"ps":0}],"sn":"GetY","rt":$n[0].Single,"p":[$n[0].Single],"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"SetText","t":8,"pi":[{"n":"text","pt":$n[3].TextMesh,"ps":0}],"sn":"SetText","rt":$n[0].Void,"p":[$n[3].TextMesh]},{"a":2,"n":"ShowText","t":8,"pi":[{"n":"pos","pt":$n[3].Vector2,"ps":0},{"n":"score","pt":$n[0].Int32,"ps":1}],"sn":"ShowText","rt":$n[0].Void,"p":[$n[3].Vector2,$n[0].Int32]},{"a":2,"n":"G","t":4,"rt":$n[0].Single,"sn":"G","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"duration","t":4,"rt":$n[0].Single,"sn":"duration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"endColor","t":4,"rt":$n[3].Color,"sn":"endColor"},{"a":2,"n":"listText","t":4,"rt":$n[4].List$1(UnityEngine.TextMesh),"sn":"listText"},{"a":2,"n":"mat","t":4,"rt":$n[3].Material,"sn":"mat"},{"a":2,"n":"scorePrefab","t":4,"rt":$n[3].GameObject,"sn":"scorePrefab"},{"a":2,"n":"speed0","t":4,"rt":$n[0].Single,"sn":"speed0","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"startColor","t":4,"rt":$n[3].Color,"sn":"startColor"}]}; }, $n);
    /*BB10_ScoreCtr end.*/

    /*BB10_ScreenCtr start.*/
    $m("BB10_ScreenCtr", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"CreateBG","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"col","pt":$n[0].Int32,"ps":1}],"sn":"CreateBG","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32]},{"a":2,"n":"Fix","t":8,"pi":[{"n":"row","pt":$n[0].Int32,"ps":0},{"n":"col","pt":$n[0].Int32,"ps":1}],"sn":"Fix","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32]},{"a":1,"n":"FixMultiScreen","t":8,"sn":"FixMultiScreen","rt":$n[0].Void},{"a":1,"n":"FixPattemPos","t":8,"sn":"FixPattemPos","rt":$n[0].Void},{"a":1,"n":"MovePart","t":8,"pi":[{"n":"part","pt":$n[3].Transform,"ps":0},{"n":"target","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"MovePart","rt":$n[1].IEnumerator,"p":[$n[3].Transform,$n[3].Vector2,$n[0].Single]},{"a":1,"n":"ScaleToFitBg","t":8,"sn":"ScaleToFitBg","rt":$n[0].Void},{"a":1,"n":"ScaleUpUnit","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"ScaleUpUnit","rt":$n[1].IEnumerator,"p":[$n[0].Int32]},{"a":1,"n":"SetAlphaAll","t":8,"pi":[{"n":"alpha","pt":$n[0].Single,"ps":0}],"sn":"SetAlphaAll","rt":$n[0].Void,"p":[$n[0].Single]},{"a":1,"n":"SetAlphaPart1","t":8,"pi":[{"n":"alpha","pt":$n[0].Single,"ps":0}],"sn":"SetAlphaPart1","rt":$n[0].Void,"p":[$n[0].Single]},{"a":2,"n":"StartAnim","t":8,"sn":"StartAnim","rt":$n[0].Void},{"a":1,"n":"StartFade","t":8,"pi":[{"n":"obj","pt":$n[3].GameObject,"ps":0},{"n":"startPos","pt":$n[3].Vector2,"ps":1},{"n":"targetPos","pt":$n[3].Vector2,"ps":2},{"n":"enableGrid","pt":$n[0].Boolean,"ps":3}],"sn":"StartFade","rt":$n[1].IEnumerator,"p":[$n[3].GameObject,$n[3].Vector2,$n[3].Vector2,$n[0].Boolean]},{"a":1,"n":"StartGridAnim","t":8,"sn":"StartGridAnim","rt":$n[1].IEnumerator},{"a":2,"n":"StartNoAnim","t":8,"sn":"StartNoAnim","rt":$n[0].Void},{"a":1,"n":"Step","t":8,"sn":"Step","rt":$n[1].IEnumerator},{"a":1,"n":"easeOutQuad","t":8,"pi":[{"n":"start","pt":$n[0].Single,"ps":0},{"n":"end","pt":$n[0].Single,"ps":1},{"n":"value","pt":$n[0].Single,"ps":2}],"sn":"easeOutQuad","rt":$n[0].Single,"p":[$n[0].Single,$n[0].Single,$n[0].Single],"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"BG","t":4,"rt":$n[3].GameObject,"sn":"BG"},{"a":2,"n":"BgUnit","t":4,"rt":$n[3].GameObject,"sn":"BgUnit"},{"a":2,"n":"F","t":4,"rt":$n[0].Single,"sn":"F","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"FUI","t":4,"rt":$n[0].Single,"sn":"FUI","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"acScale","t":4,"rt":pc.AnimationCurve,"sn":"acScale"},{"a":2,"n":"bottomTrans","t":4,"rt":$n[3].Transform,"sn":"bottomTrans"},{"a":2,"n":"cam","t":4,"rt":$n[3].Camera,"sn":"cam"},{"a":1,"n":"currentScren","t":4,"rt":$n[0].Single,"sn":"currentScren","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"defaultPattemUIY","t":4,"rt":$n[0].Single,"sn":"defaultPattemUIY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"defaultPattemY","t":4,"rt":$n[0].Single,"sn":"defaultPattemY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"defaultScreen","t":4,"rt":$n[0].Single,"sn":"defaultScreen","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"distanceEdge","t":4,"rt":$n[0].Single,"sn":"distanceEdge","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"distanceMoveFade","t":4,"rt":$n[0].Single,"sn":"distanceMoveFade","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationFadeIn","t":4,"rt":$n[0].Single,"sn":"durationFadeIn","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationScaleUp","t":4,"rt":$n[0].Single,"sn":"durationScaleUp","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"grid","t":4,"rt":System.Array.type(UnityEngine.GameObject),"sn":"grid"},{"a":2,"n":"gridMoving","t":4,"rt":$n[0].Boolean,"sn":"gridMoving","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"listPattemTrans","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"listPattemTrans"},{"a":1,"n":"listSprites","t":4,"rt":System.Array.type(UnityEngine.SpriteRenderer, 2),"sn":"listSprites"},{"a":1,"n":"myC","t":4,"rt":$n[0].Int32,"sn":"myC","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"myR","t":4,"rt":$n[0].Int32,"sn":"myR","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"orthographicSizeMin","t":4,"rt":$n[0].Single,"sn":"orthographicSizeMin","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"parentCell","t":4,"rt":$n[3].Transform,"sn":"parentCell"},{"a":2,"n":"partDown","t":4,"rt":$n[3].Transform,"sn":"partDown"},{"a":2,"n":"partLeft","t":4,"rt":$n[3].Transform,"sn":"partLeft"},{"a":2,"n":"partRight","t":4,"rt":$n[3].Transform,"sn":"partRight"},{"a":2,"n":"partTop","t":4,"rt":$n[3].Transform,"sn":"partTop"},{"a":2,"n":"startAlpha","t":4,"rt":$n[0].Single,"sn":"startAlpha","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"targetAlpha","t":4,"rt":$n[0].Single,"sn":"targetAlpha","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"topRec","t":4,"rt":$n[3].RectTransform,"sn":"topRec"},{"a":2,"n":"waitStep","t":4,"rt":$n[0].Single,"sn":"waitStep","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BB10_ScreenCtr end.*/
    ...
    /*BB10_ShowHelpCtr start.*/
    $m("BB10_ShowHelpCtr", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"GetBlock","t":8,"sn":"GetBlock","rt":$n[3].GameObject},{"a":2,"n":"HideAllBlock","t":8,"sn":"HideAllBlock","rt":$n[0].Void},{"a":2,"n":"SetBlock","t":8,"pi":[{"n":"block","pt":$n[3].GameObject,"ps":0}],"sn":"SetBlock","rt":$n[0].Void,"p":[$n[3].GameObject]},{"a":2,"n":"ShowHelp","t":8,"pi":[{"n":"listBlock","pt":$n[4].List$1(BB10_BrickCubeUnit),"ps":0},{"n":"posValid","pt":$n[3].Vector2,"ps":1}],"sn":"ShowHelp","rt":$n[0].Void,"p":[$n[4].List$1(BB10_BrickCubeUnit),$n[3].Vector2]},{"a":2,"n":"groundPrefab","t":4,"rt":$n[3].GameObject,"sn":"groundPrefab"},{"a":2,"n":"listBlockActive","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"listBlockActive"},{"a":2,"n":"listBlockDisable","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"listBlockDisable"}]}; }, $n);
    /*BB10_ShowHelpCtr end.*/

    /*BB10_Tutorial start.*/
    $m("BB10_Tutorial", function () { return {"nested":[BB10_Tutorial.State],"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"FinishMap3","t":8,"sn":"FinishMap3","rt":$n[1].IEnumerator},{"a":1,"n":"FinishMap5","t":8,"sn":"FinishMap5","rt":$n[1].IEnumerator},{"a":1,"n":"LoadMap1","t":8,"sn":"LoadMap1","rt":$n[0].Void},{"a":1,"n":"LoadMap2","t":8,"sn":"LoadMap2","rt":$n[0].Void},{"a":1,"n":"LoadMap3","t":8,"sn":"LoadMap3","rt":$n[0].Void},{"a":2,"n":"Next","t":8,"sn":"Next","rt":$n[0].Void},{"a":1,"n":"OpenMap1","t":8,"sn":"OpenMap1","rt":$n[0].Void},{"a":1,"n":"OpenMap2","t":8,"sn":"OpenMap2","rt":$n[0].Void},{"a":1,"n":"OpenMap3","t":8,"sn":"OpenMap3","rt":$n[0].Void},{"a":1,"n":"OpenMap4","t":8,"sn":"OpenMap4","rt":$n[0].Void},{"a":1,"n":"OpenMap5","t":8,"sn":"OpenMap5","rt":$n[0].Void},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"Show","t":8,"sn":"Show","rt":$n[0].Void},{"a":2,"n":"SkipTut","t":8,"sn":"SkipTut","rt":$n[0].Void},{"a":2,"n":"StartFinger","t":8,"sn":"StartFinger","rt":$n[0].Void},{"a":1,"n":"StartMoveFinger","t":8,"pi":[{"n":"startPos","pt":$n[3].Vector2,"ps":0},{"n":"targetPos","pt":$n[3].Vector2,"ps":1}],"sn":"StartMoveFinger","rt":$n[1].IEnumerator,"p":[$n[3].Vector2,$n[3].Vector2]},{"a":2,"n":"StopFinger","t":8,"sn":"StopFinger","rt":$n[0].Void},{"a":1,"n":"WaitOpenMap2","t":8,"sn":"WaitOpenMap2","rt":$n[1].IEnumerator},{"a":1,"n":"WaitOpenMap3","t":8,"sn":"WaitOpenMap3","rt":$n[1].IEnumerator},{"a":1,"n":"WaitOpenMap4","t":8,"sn":"WaitOpenMap4","rt":$n[1].IEnumerator},{"a":1,"n":"WaitOpenMap5","t":8,"sn":"WaitOpenMap5","rt":$n[1].IEnumerator},{"a":1,"n":"FingerMove","t":4,"rt":$n[1].IEnumerator,"sn":"FingerMove"},{"a":2,"n":"circle","t":4,"rt":$n[3].GameObject,"sn":"circle"},{"a":2,"n":"durationMoveDown","t":4,"rt":$n[0].Single,"sn":"durationMoveDown","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationMoveShort","t":4,"rt":$n[0].Single,"sn":"durationMoveShort","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationMoveUp","t":4,"rt":$n[0].Single,"sn":"durationMoveUp","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationScale","t":4,"rt":$n[0].Single,"sn":"durationScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"finger","t":4,"rt":$n[3].GameObject,"sn":"finger"},{"a":1,"n":"grid","t":4,"rt":BB10_Grid,"sn":"grid"},{"a":1,"n":"normalScale","t":4,"rt":$n[3].Vector3,"sn":"normalScale"},{"a":1,"n":"smallScale","t":4,"rt":$n[3].Vector3,"sn":"smallScale"},{"a":2,"n":"state","t":4,"rt":BB10_Tutorial.State,"sn":"state","box":function ($v) { return Bridge.box($v, BB10_Tutorial.State, System.Enum.toStringFn(BB10_Tutorial.State));}}]}; }, $n);
    /*BB10_Tutorial end.*/
    ...
    /*BoomControl start.*/
    $m("BoomControl", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"GetBoom","t":8,"sn":"GetBoom","rt":$n[3].GameObject},{"a":2,"n":"SetBoom","t":8,"pi":[{"n":"boom","pt":$n[3].GameObject,"ps":0}],"sn":"SetBoom","rt":$n[0].Void,"p":[$n[3].GameObject]},{"a":2,"n":"ShowBoom","t":8,"pi":[{"n":"pos","pt":$n[3].Vector3,"ps":0},{"n":"data","pt":BB10_ColorData,"ps":1}],"sn":"ShowBoom","rt":$n[0].Void,"p":[$n[3].Vector3,BB10_ColorData]},{"a":2,"n":"boomPrefab","t":4,"rt":$n[3].GameObject,"sn":"boomPrefab"},{"a":2,"n":"listBoom","t":4,"rt":$n[4].List$1(UnityEngine.GameObject),"sn":"listBoom"}]}; }, $n);
    /*BoomControl end.*/

    /*CameraScript start.*/
    $m("CameraScript", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"cam","t":4,"rt":$n[3].Camera,"sn":"cam"}]}; }, $n);
    /*CameraScript end.*/

    /*ItemUnit start.*/
    $m("ItemUnit", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ButtonClick","t":8,"sn":"ButtonClick","rt":$n[1].IEnumerator},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":2,"n":"OnPointerClick","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnPointerClick","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":2,"n":"SetLock","t":8,"sn":"SetLock","rt":$n[0].Void},{"a":2,"n":"SetOpen","t":8,"pi":[{"n":"maxLv","pt":$n[0].Int32,"ps":0}],"sn":"SetOpen","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"index","t":4,"rt":$n[0].Int32,"sn":"index","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"lockObj","t":4,"rt":$n[3].GameObject,"sn":"lockObj"},{"a":2,"n":"numberText","t":4,"rt":$n[2].Text,"sn":"numberText"},{"a":2,"n":"openObj","t":4,"rt":$n[3].GameObject,"sn":"openObj"},{"a":1,"n":"running","t":4,"rt":$n[0].Boolean,"sn":"running","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"scaleZoom","t":4,"rt":$n[3].Vector3,"sn":"scaleZoom"},{"a":2,"n":"star1","t":4,"rt":StarLevelControl,"sn":"star1"},{"a":2,"n":"star2","t":4,"rt":StarLevelControl,"sn":"star2"},{"a":2,"n":"star3","t":4,"rt":StarLevelControl,"sn":"star3"},{"a":1,"n":"timeZoomIn","t":4,"rt":$n[0].Single,"sn":"timeZoomIn","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"timeZoomOut","t":4,"rt":$n[0].Single,"sn":"timeZoomOut","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*ItemUnit end.*/
    ...
    /*StarLevelControl start.*/
    $m("StarLevelControl", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetActiveObj","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActiveObj","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"starObj","t":4,"rt":$n[3].GameObject,"sn":"starObj"}]}; }, $n);
    /*StarLevelControl end.*/

    /*Vec2 start.*/
    $m("Vec2", function () { return {"att":1048577,"a":2,"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":".ctor","t":1,"p":[$n[3].Vector2],"pi":[{"n":"vec","pt":$n[3].Vector2,"ps":0}],"sn":"$ctor2"},{"a":2,"n":".ctor","t":1,"p":[Vec2],"pi":[{"n":"vec","pt":Vec2,"ps":0}],"sn":"$ctor3"},{"a":2,"n":".ctor","t":1,"p":[$n[0].Int32,$n[0].Int32],"pi":[{"n":"r","pt":$n[0].Int32,"ps":0},{"n":"c","pt":$n[0].Int32,"ps":1}],"sn":"$ctor1"},{"a":2,"n":"FastDistance","is":true,"t":8,"pi":[{"n":"v1","pt":Vec2,"ps":0},{"n":"v2","pt":Vec2,"ps":1}],"sn":"FastDistance","rt":$n[0].Int32,"p":[Vec2,Vec2],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"Print","t":8,"sn":"Print","rt":$n[0].String},{"a":2,"n":"C","t":4,"rt":$n[0].Int32,"sn":"C","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"R","t":4,"rt":$n[0].Int32,"sn":"R","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"c","is":true,"t":4,"rt":$n[0].Int32,"sn":"c","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"r","is":true,"t":4,"rt":$n[0].Int32,"sn":"r","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*Vec2 end.*/

    /*BB10_CupShaker start.*/
    $m("BB10_CupShaker", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"StartEffect","t":8,"sn":"StartEffect","rt":$n[1].IEnumerator},{"a":1,"n":"StartMove","t":8,"sn":"StartMove","rt":$n[1].IEnumerator},{"a":2,"n":"StartShake","t":8,"sn":"StartShake","rt":$n[0].Void},{"a":2,"n":"delay","t":4,"rt":$n[0].Single,"sn":"delay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"distanceMove","t":4,"rt":$n[0].Single,"sn":"distanceMove","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"duration","t":4,"rt":$n[0].Single,"sn":"duration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationMove","t":4,"rt":$n[0].Single,"sn":"durationMove","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"fromAngle","t":4,"rt":$n[0].Single,"sn":"fromAngle","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"normalPos","t":4,"rt":$n[3].Vector2,"sn":"normalPos"},{"a":2,"n":"rec","t":4,"rt":$n[3].RectTransform,"sn":"rec"},{"a":1,"n":"running","t":4,"rt":$n[0].Boolean,"sn":"running","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"scale","t":4,"rt":$n[0].Single,"sn":"scale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"timeShake","t":4,"rt":$n[0].Int32,"sn":"timeShake","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"toAngle","t":4,"rt":$n[0].Single,"sn":"toAngle","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"waitMoveDown","t":4,"rt":$n[0].Single,"sn":"waitMoveDown","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BB10_CupShaker end.*/

    /*BB10_FaderHandler start.*/
    $m("BB10_FaderHandler", function () { return {"nested":[Function],"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Fade","t":8,"pi":[{"n":"fn","pt":Function,"ps":0}],"sn":"Fade","rt":$n[0].Void,"p":[Function]},{"a":2,"n":"FadeInPanel","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"FadeInPanel","rt":$n[0].Void,"p":[$n[3].CanvasGroup,Function]},{"a":2,"n":"FadeInPanelFix","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"FadeInPanelFix","rt":$n[0].Void,"p":[$n[3].CanvasGroup,Function]},{"a":2,"n":"FadeOutPanel","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"FadeOutPanel","rt":$n[0].Void,"p":[$n[3].CanvasGroup,Function]},{"a":2,"n":"FadeOutPanelFix","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"FadeOutPanelFix","rt":$n[0].Void,"p":[$n[3].CanvasGroup,Function]},{"a":2,"n":"Reset","t":8,"sn":"Reset","rt":$n[0].Void},{"a":1,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"StartFade","t":8,"pi":[{"n":"fn","pt":Function,"ps":0}],"sn":"StartFade","rt":$n[1].IEnumerator,"p":[Function]},{"a":1,"n":"StartFadeInPanel","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"StartFadeInPanel","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,Function]},{"a":1,"n":"StartFadeInPanelFix","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"StartFadeInPanelFix","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,Function]},{"a":1,"n":"StartFadeOutPanel","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"StartFadeOutPanel","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,Function]},{"a":1,"n":"StartFadeOutPanelFix","t":8,"pi":[{"n":"group","pt":$n[3].CanvasGroup,"ps":0},{"n":"fn","pt":Function,"ps":1}],"sn":"StartFadeOutPanelFix","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,Function]},{"a":1,"n":"StartSwichPanel","t":8,"pi":[{"n":"group1","pt":$n[3].CanvasGroup,"ps":0},{"n":"group2","pt":$n[3].CanvasGroup,"ps":1},{"n":"fn","pt":Function,"ps":2}],"sn":"StartSwichPanel","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,$n[3].CanvasGroup,Function]},{"a":1,"n":"StartSwichPanelFix","t":8,"pi":[{"n":"group1","pt":$n[3].CanvasGroup,"ps":0},{"n":"group2","pt":$n[3].CanvasGroup,"ps":1},{"n":"fn","pt":Function,"ps":2}],"sn":"StartSwichPanelFix","rt":$n[1].IEnumerator,"p":[$n[3].CanvasGroup,$n[3].CanvasGroup,Function]},{"a":2,"n":"SwichPanel","t":8,"pi":[{"n":"group1","pt":$n[3].CanvasGroup,"ps":0},{"n":"group2","pt":$n[3].CanvasGroup,"ps":1},{"n":"fn","pt":Function,"ps":2}],"sn":"SwichPanel","rt":$n[0].Void,"p":[$n[3].CanvasGroup,$n[3].CanvasGroup,Function]},{"a":2,"n":"SwichPanelFix","t":8,"pi":[{"n":"group1","pt":$n[3].CanvasGroup,"ps":0},{"n":"group2","pt":$n[3].CanvasGroup,"ps":1},{"n":"fn","pt":Function,"ps":2}],"sn":"SwichPanelFix","rt":$n[0].Void,"p":[$n[3].CanvasGroup,$n[3].CanvasGroup,Function]},{"a":2,"n":"durationFade","t":4,"rt":$n[0].Single,"sn":"durationFade","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationFadeOut","t":4,"rt":$n[0].Single,"sn":"durationFadeOut","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"durationSwich","t":4,"rt":$n[0].Single,"sn":"durationSwich","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"image","t":4,"rt":$n[2].Image,"sn":"image"}]}; }, $n);
    /*BB10_FaderHandler end.*/

    /*BB10_HomeController start.*/
    $m("BB10_HomeController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CheckSound","t":8,"sn":"CheckSound","rt":$n[0].Void},{"a":2,"n":"HideHome","t":8,"sn":"HideHome","rt":$n[0].Void},{"a":2,"n":"MidleTryAgain","t":8,"sn":"MidleTryAgain","rt":$n[0].Void},{"a":1,"n":"OffFading","t":8,"sn":"OffFading","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":2,"n":"PreLoad","t":8,"sn":"PreLoad","rt":$n[0].Void},{"a":2,"n":"PrivacyPolicy","t":8,"sn":"PrivacyPolicy","rt":$n[0].Void},{"a":2,"n":"Reset","t":8,"sn":"Reset","rt":$n[0].Void},{"a":2,"n":"Restart","t":8,"sn":"Restart","rt":$n[0].Void},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"ShowHome","t":8,"sn":"ShowHome","rt":$n[0].Void},{"a":2,"n":"SoundClick","t":8,"sn":"SoundClick","rt":$n[0].Void},{"a":2,"n":"group","t":4,"rt":$n[3].CanvasGroup,"sn":"group"},{"a":1,"n":"isFading","t":4,"rt":$n[0].Boolean,"sn":"isFading","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*BB10_HomeController end.*/

    /*BB10_InGameScript start.*/
    $m("BB10_InGameScript", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"FinishTut","t":8,"sn":"FinishTut","rt":$n[0].Void},{"a":2,"n":"Pause","t":8,"sn":"Pause","rt":$n[0].Void},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"Reset","t":8,"sn":"Reset","rt":$n[0].Void},{"a":2,"n":"ResetBest","t":8,"sn":"ResetBest","rt":$n[0].Void},{"a":2,"n":"ResetScore","t":8,"sn":"ResetScore","rt":$n[0].Void},{"a":1,"n":"ScoreUpAnim","t":8,"pi":[{"n":"fromScore","pt":$n[0].Int32,"ps":0}],"sn":"ScoreUpAnim","rt":$n[1].IEnumerator,"p":[$n[0].Int32]},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetNewScore","t":8,"pi":[{"n":"scoreFillLine","pt":$n[0].Int32,"ps":0},{"n":"numberUnit","pt":$n[0].Int32,"ps":1}],"sn":"SetNewScore","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32]},{"a":2,"n":"SetScoreContinue","t":8,"pi":[{"n":"value","pt":$n[0].Int32,"ps":0}],"sn":"SetScoreContinue","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"SkipTut","t":8,"sn":"SkipTut","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"StartTut","t":8,"sn":"StartTut","rt":$n[0].Void},{"a":2,"n":"UpScoreTxt","t":8,"pi":[{"n":"value","pt":$n[0].Int32,"ps":0}],"sn":"UpScoreTxt","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"bestInt","t":4,"rt":$n[0].Int32,"sn":"bestInt","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"bestTxt","t":4,"rt":$n[3].TextMesh,"sn":"bestTxt"},{"a":2,"n":"blur_1","t":4,"rt":$n[3].GameObject,"sn":"blur_1"},{"a":2,"n":"group","t":4,"rt":$n[3].CanvasGroup,"sn":"group"},{"a":2,"n":"rec","t":4,"rt":$n[3].RectTransform,"sn":"rec"},{"a":2,"n":"scoreInt","t":4,"rt":$n[0].Int32,"sn":"scoreInt","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"scoreRuning","t":4,"rt":$n[0].Boolean,"sn":"scoreRuning","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"scoreTxt","t":4,"rt":$n[3].TextMesh,"sn":"scoreTxt"},{"a":1,"n":"scoreUp","t":4,"rt":$n[1].IEnumerator,"sn":"scoreUp"}]}; }, $n);
    /*BB10_InGameScript end.*/

    /*BB10_LostScript start.*/
    $m("BB10_LostScript", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"AnimScore","t":8,"sn":"AnimScore","rt":$n[0].Void},{"a":2,"n":"GameOver","t":8,"pi":[{"n":"isGray","pt":$n[0].Boolean,"ps":0}],"sn":"GameOver","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"MidleTryAgain","t":8,"sn":"MidleTryAgain","rt":$n[0].Void},{"a":1,"n":"NextGame","t":8,"sn":"NextGame","rt":$n[0].Void},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"Reset","t":8,"sn":"Reset","rt":$n[0].Void},{"a":1,"n":"ScoreUpAnim","t":8,"sn":"ScoreUpAnim","rt":$n[1].IEnumerator},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetBestScore","t":8,"sn":"SetBestScore","rt":$n[0].Void},{"a":2,"n":"SetScore","t":8,"pi":[{"n":"score","pt":$n[0].Int32,"ps":0}],"sn":"SetScore","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"TryAgainButton","t":8,"sn":"TryAgainButton","rt":$n[0].Void},{"a":1,"n":"WaitState","t":8,"sn":"WaitState","rt":$n[1].IEnumerator},{"a":1,"n":"WaitSwitch","t":8,"pi":[{"n":"isGray","pt":$n[0].Boolean,"ps":0}],"sn":"WaitSwitch","rt":$n[1].IEnumerator,"p":[$n[0].Boolean]},{"a":1,"n":"AnimSoundLoop","t":4,"rt":$n[1].IEnumerator,"sn":"AnimSoundLoop"},{"a":2,"n":"POST_SCORE_NUMBER_KEY","is":true,"t":4,"rt":$n[0].String,"sn":"POST_SCORE_NUMBER_KEY"},{"a":2,"n":"SCORE_TOTAL_KEY","is":true,"t":4,"rt":$n[0].String,"sn":"SCORE_TOTAL_KEY"},{"a":2,"n":"bestText","t":4,"rt":$n[2].Text,"sn":"bestText"},{"a":1,"n":"checkToRate","t":4,"rt":$n[0].Boolean,"sn":"checkToRate","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"cupShaker","t":4,"rt":BB10_CupShaker,"sn":"cupShaker"},{"a":1,"n":"fistGameOver","is":true,"t":4,"rt":$n[0].Boolean,"sn":"fistGameOver","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"group","t":4,"rt":$n[3].CanvasGroup,"sn":"group"},{"a":2,"n":"isAuto","t":4,"rt":$n[0].Boolean,"sn":"isAuto","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"listViewAdsPannel","t":4,"rt":$n[3].GameObject,"sn":"listViewAdsPannel"},{"a":1,"n":"score","t":4,"rt":$n[0].Int32,"sn":"score","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"scoreCounting","t":4,"rt":$n[0].Boolean,"sn":"scoreCounting","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"scoreText","t":4,"rt":$n[2].Text,"sn":"scoreText"}]}; }, $n);
    /*BB10_LostScript end.*/

    /*BB10_MainCanvasUI start.*/
    $m("BB10_MainCanvasUI", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"CheckBundle","t":8,"sn":"CheckBundle","rt":$n[0].Void},{"a":1,"n":"CheckPreloadTutorial","t":8,"sn":"CheckPreloadTutorial","rt":$n[0].Void},{"a":1,"n":"CheckToReloadBanner","t":8,"sn":"CheckToReloadBanner","rt":$n[0].Void},{"a":1,"n":"EffectGrid","t":8,"sn":"EffectGrid","rt":$n[0].Void},{"a":1,"n":"EnsureAdBreakManager","t":8,"sn":"EnsureAdBreakManager","rt":$n[0].Void},{"a":2,"n":"FadeIn","t":8,"sn":"FadeIn","rt":$n[0].Void},{"a":2,"n":"FadeOut","t":8,"sn":"FadeOut","rt":$n[0].Void},{"a":1,"n":"InitGame","t":8,"sn":"InitGame","rt":$n[1].IEnumerator},{"a":1,"n":"Load","t":8,"sn":"Load","rt":$n[0].Void},{"a":1,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"Reset","t":8,"pi":[{"n":"isIngame","pt":$n[0].Boolean,"ps":0}],"sn":"Reset","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"ShowBannerDelay","t":8,"sn":"ShowBannerDelay","rt":$n[1].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"StartGame","t":8,"sn":"StartGame","rt":$n[0].Void},{"a":2,"n":"StopWaitShowAdBreask","t":8,"sn":"StopWaitShowAdBreask","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"loadPattemDelay","t":8,"sn":"loadPattemDelay","rt":$n[1].IEnumerator},{"a":2,"n":"Main","is":true,"t":16,"rt":BB10_MainCanvasUI,"g":{"a":2,"n":"get_Main","t":8,"rt":BB10_MainCanvasUI,"fg":"Main","is":true},"fn":"Main"},{"a":2,"n":"OnDropPiece","t":4,"rt":Function,"sn":"OnDropPiece"},{"a":2,"n":"OnNeedStopAdBreak","t":4,"rt":Function,"sn":"OnNeedStopAdBreak"},{"a":2,"n":"blur","t":4,"rt":$n[3].GameObject,"sn":"blur"},{"a":2,"n":"faderScript","t":4,"rt":BB10_FaderHandler,"sn":"faderScript"},{"a":1,"n":"firstLoaded","is":true,"t":4,"rt":$n[0].Boolean,"sn":"firstLoaded","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"inGameScript","t":4,"rt":BB10_InGameScript,"sn":"inGameScript"},{"a":2,"n":"mainCanvas","is":true,"t":4,"rt":BB10_MainCanvasUI,"sn":"mainCanvas"},{"a":2,"n":"newSession","is":true,"t":4,"rt":$n[0].Boolean,"sn":"newSession","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"timePlay","is":true,"t":4,"rt":$n[0].Int32,"sn":"timePlay","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*BB10_MainCanvasUI end.*/

    /*BB10_PauseScript start.*/
    $m("BB10_PauseScript", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CheckSound","t":8,"sn":"CheckSound","rt":$n[0].Void},{"a":2,"n":"MidleTryAgain","t":8,"sn":"MidleTryAgain","rt":$n[0].Void},{"a":1,"n":"OffFading","t":8,"sn":"OffFading","rt":$n[0].Void},{"a":2,"n":"PauseGame","t":8,"sn":"PauseGame","rt":$n[0].Void},{"a":2,"n":"PreLoad","t":8,"sn":"PreLoad","rt":$n[0].Void},{"a":2,"n":"Reset","t":8,"sn":"Reset","rt":$n[0].Void},{"a":2,"n":"Restart","t":8,"sn":"Restart","rt":$n[0].Void},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"ShowHome","t":8,"sn":"ShowHome","rt":$n[0].Void},{"a":2,"n":"SoundClick","t":8,"sn":"SoundClick","rt":$n[0].Void},{"a":2,"n":"UnPause","t":8,"sn":"UnPause","rt":$n[0].Void},{"a":2,"n":"group","t":4,"rt":$n[3].CanvasGroup,"sn":"group"},{"a":1,"n":"isFading","t":4,"rt":$n[0].Boolean,"sn":"isFading","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"soundIgame","t":4,"rt":$n[2].Image,"sn":"soundIgame"},{"a":2,"n":"soundOff","t":4,"rt":$n[3].Sprite,"sn":"soundOff"},{"a":2,"n":"soundOn","t":4,"rt":$n[3].Sprite,"sn":"soundOn"}]}; }, $n);
    /*BB10_PauseScript end.*/

    /*BB10_PopupRate start.*/
    $m("BB10_PopupRate", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CloseBtn","t":8,"sn":"CloseBtn","rt":$n[0].Void},{"a":2,"n":"HandleClickStar","t":8,"sn":"HandleClickStar","rt":$n[0].Void},{"a":2,"n":"HandleRate4Star","t":8,"sn":"HandleRate4Star","rt":$n[0].Void},{"a":2,"n":"HandleRate5Star","t":8,"sn":"HandleRate5Star","rt":$n[0].Void},{"a":2,"n":"HandleSubmit","t":8,"sn":"HandleSubmit","rt":$n[0].Void},{"a":2,"n":"HidePopup","t":8,"sn":"HidePopup","rt":$n[0].Void},{"a":1,"n":"InitPopup","t":8,"sn":"InitPopup","rt":$n[0].Void},{"a":2,"n":"Preload","t":8,"sn":"Preload","rt":$n[0].Void},{"a":2,"n":"Rate","is":true,"t":8,"sn":"Rate","rt":$n[0].Void},{"a":2,"n":"ShowPopup","t":8,"sn":"ShowPopup","rt":$n[0].Void},{"a":2,"n":"pannel","t":4,"rt":$n[3].GameObject,"sn":"pannel"},{"a":2,"n":"popup","t":4,"rt":$n[3].GameObject,"sn":"popup"},{"a":2,"n":"rate_inpopup_key","is":true,"t":4,"rt":$n[0].String,"sn":"rate_inpopup_key"},{"a":2,"n":"starList","t":4,"rt":$n[4].List$1(BB10_RateStar),"sn":"starList"},{"a":2,"n":"starNumber","t":4,"rt":$n[0].Int32,"sn":"starNumber","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"starOff","t":4,"rt":$n[3].Sprite,"sn":"starOff"},{"a":2,"n":"starOn","t":4,"rt":$n[3].Sprite,"sn":"starOn"},{"a":2,"n":"submit","t":4,"rt":$n[3].GameObject,"sn":"submit"},{"a":2,"n":"textRate","t":4,"rt":$n[3].GameObject,"sn":"textRate"}]}; }, $n);
    /*BB10_PopupRate end.*/

    /*BB10_RateStar start.*/
    $m("BB10_RateStar", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"HandleClickStar","t":8,"sn":"HandleClickStar","rt":$n[0].Void},{"a":2,"n":"starImg","t":4,"rt":$n[2].Image,"sn":"starImg"},{"a":2,"n":"starNumber","t":4,"rt":$n[0].Int32,"sn":"starNumber","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*BB10_RateStar end.*/

    /*Exit start.*/
    $m("Exit", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Reset","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"Reset","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"StartWait","t":8,"pi":[{"n":"isHome","pt":$n[0].Boolean,"ps":0}],"sn":"StartWait","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"Wait","t":8,"pi":[{"n":"isHome","pt":$n[0].Boolean,"ps":0}],"sn":"Wait","rt":$n[1].IEnumerator,"p":[$n[0].Boolean]},{"a":2,"n":"duration","t":4,"rt":$n[0].Single,"sn":"duration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*Exit end.*/

    /*GameDefine start.*/
    $m("GameDefine", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"GetScore","is":true,"t":8,"pi":[{"n":"numberLine","pt":$n[0].Int32,"ps":0}],"sn":"GetScore","rt":$n[0].Int32,"p":[$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"freeLayer","is":true,"t":4,"rt":$n[0].Int32,"sn":"freeLayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"pageID","is":true,"t":4,"rt":$n[0].String,"sn":"pageID"},{"a":2,"n":"pageName","is":true,"t":4,"rt":$n[0].String,"sn":"pageName"},{"a":2,"n":"pattemDarkAlpha","is":true,"t":4,"rt":$n[0].Single,"sn":"pattemDarkAlpha","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"pattemLightAlpha","is":true,"t":4,"rt":$n[0].Single,"sn":"pattemLightAlpha","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"pikachuNormalScale","is":true,"t":4,"rt":$n[0].Single,"sn":"pikachuNormalScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"pikachuYScale","is":true,"t":4,"rt":$n[0].Single,"sn":"pikachuYScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"posCenter","is":true,"t":4,"rt":$n[3].Vector2,"sn":"posCenter"},{"a":2,"n":"posLeft","is":true,"t":4,"rt":$n[3].Vector2,"sn":"posLeft"},{"a":2,"n":"posRight","is":true,"t":4,"rt":$n[3].Vector2,"sn":"posRight"},{"a":2,"n":"posTop","is":true,"t":4,"rt":$n[3].Vector2,"sn":"posTop"},{"a":2,"n":"selectingLayer","is":true,"t":4,"rt":$n[0].Int32,"sn":"selectingLayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"startCol","is":true,"t":4,"rt":$n[0].Int32,"sn":"startCol","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"startRow","is":true,"t":4,"rt":$n[0].Int32,"sn":"startRow","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*GameDefine end.*/

    /*OnClickCanvasButton start.*/
    $m("OnClickCanvasButton", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ButtonClick","t":8,"sn":"ButtonClick","rt":$n[1].IEnumerator},{"a":1,"n":"OnApplicationPause","t":8,"sn":"OnApplicationPause","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":2,"n":"OnPointerClick","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnPointerClick","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":2,"n":"onClick","t":4,"rt":$n[6].UnityEvent,"sn":"onClick"},{"a":1,"n":"running","t":4,"rt":$n[0].Boolean,"sn":"running","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"scaleZoom","t":4,"rt":$n[3].Vector3,"sn":"scaleZoom"},{"a":1,"n":"timeZoomIn","t":4,"rt":$n[0].Single,"sn":"timeZoomIn","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"timeZoomOut","t":4,"rt":$n[0].Single,"sn":"timeZoomOut","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*OnClickCanvasButton end.*/
    ...
    /*DG.Tweening.DOTweenModuleAudio start.*/
    $m("DG.Tweening.DOTweenModuleAudio", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOComplete","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0},{"n":"withCallbacks","dv":false,"o":true,"pt":$n[0].Boolean,"ps":1}],"sn":"DOComplete","rt":$n[0].Int32,"p":[$n[7].AudioMixer,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].AudioSource,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[3].AudioSource,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlip","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOFlip","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOGoto","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0},{"n":"to","pt":$n[0].Single,"ps":1},{"n":"andPlay","dv":false,"o":true,"pt":$n[0].Boolean,"ps":2}],"sn":"DOGoto","rt":$n[0].Int32,"p":[$n[7].AudioMixer,$n[0].Single,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOKill","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0},{"n":"complete","dv":false,"o":true,"pt":$n[0].Boolean,"ps":1}],"sn":"DOKill","rt":$n[0].Int32,"p":[$n[7].AudioMixer,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPause","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOPause","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPitch","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].AudioSource,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPitch","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[3].AudioSource,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPlay","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOPlay","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPlayBackwards","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOPlayBackwards","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPlayForward","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOPlayForward","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DORestart","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DORestart","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DORewind","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DORewind","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOSetFloat","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0},{"n":"floatName","pt":$n[0].String,"ps":1},{"n":"endValue","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3}],"sn":"DOSetFloat","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[7].AudioMixer,$n[0].String,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOSmoothRewind","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOSmoothRewind","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOTogglePause","is":true,"t":8,"pi":[{"n":"target","pt":$n[7].AudioMixer,"ps":0}],"sn":"DOTogglePause","rt":$n[0].Int32,"p":[$n[7].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*DG.Tweening.DOTweenModuleAudio end.*/

    /*DG.Tweening.DOTweenModulePhysics start.*/
    $m("DG.Tweening.DOTweenModulePhysics", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[3].Vector3,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[9].Sequence,"p":[$n[3].Rigidbody,$n[3].Vector3,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"path","pt":$n[10].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody,$n[10].Path,$n[0].Single,$n[9].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[9].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[9].PathType,$n[9].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOLookAt","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"towards","pt":$n[3].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"axisConstraint","dv":0,"o":true,"pt":$n[9].AxisConstraint,"ps":3},{"n":"up","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Vector3),"ps":4}],"sn":"DOLookAt","rt":$n[8].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[3].Rigidbody,$n[3].Vector3,$n[0].Single,$n[9].AxisConstraint,$n[0].Nullable$1(UnityEngine.Vector3)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[3].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody,$n[3].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveZ","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"path","pt":$n[10].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody,$n[10].Path,$n[0].Single,$n[9].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[9].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[9].PathType,$n[9].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody,"ps":0},{"n":"endValue","pt":$n[3].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"mode","dv":0,"o":true,"pt":$n[9].RotateMode,"ps":3}],"sn":"DORotate","rt":$n[8].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[3].Rigidbody,$n[3].Vector3,$n[0].Single,$n[9].RotateMode]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics end.*/

    /*DG.Tweening.DOTweenModulePhysics2D start.*/
    $m("DG.Tweening.DOTweenModulePhysics2D", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[9].Sequence,"p":[$n[3].Rigidbody2D,$n[3].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"path","pt":$n[10].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody2D,$n[10].Path,$n[0].Single,$n[9].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[9].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[9].PathType,$n[9].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody2D,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"path","pt":$n[10].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody2D,$n[10].Path,$n[0].Single,$n[9].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[9].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[9].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[9].PathType,$n[9].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DORotate","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[3].Rigidbody2D,$n[0].Single,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics2D end.*/

    /*DG.Tweening.DOTweenModuleSprite start.*/
    $m("DG.Tweening.DOTweenModuleSprite", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[9].Tweener,"p":[$n[3].SpriteRenderer,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[3].SpriteRenderer,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[3].SpriteRenderer,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].SpriteRenderer,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[9].Sequence,"p":[$n[3].SpriteRenderer,pc.ColorGradient,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleSprite end.*/

    /*DG.Tweening.DOTweenModuleUI start.*/
    $m("DG.Tweening.DOTweenModuleUI", function () { return {"nested":[$n[9].DOTweenModuleUI.Utils],"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOAnchorMax","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMax","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorMin","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMin","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3D","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3D","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DX","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DX","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DY","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DY","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DZ","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosX","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosX","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosY","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosY","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Graphic,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[9].Tweener,"p":[$n[2].Graphic,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Image,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$1","rt":$n[9].Tweener,"p":[$n[2].Image,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Text,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$2","rt":$n[9].Tweener,"p":[$n[2].Text,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Graphic,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Graphic,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Image,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$1","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Image,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Outline,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$2","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Outline,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Text,"ps":0},{"n":"endValue","pt":$n[3].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$3","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Text,$n[3].Color,$n[0].Single]},{"a":2,"n":"DOCounter","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Text,"ps":0},{"n":"fromValue","pt":$n[0].Int32,"ps":1},{"n":"endValue","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"addThousandsSeparator","dv":true,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"culture","dv":null,"o":true,"pt":$n[11].CultureInfo,"ps":5}],"sn":"DOCounter","rt":$n[8].TweenerCore$3(System.Int32,System.Int32,DG.Tweening.Plugins.Options.NoOptions),"p":[$n[2].Text,$n[0].Int32,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[11].CultureInfo]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].CanvasGroup,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[3].CanvasGroup,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Graphic,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$1","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Graphic,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$2","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Outline,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$3","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Outline,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Text,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$4","rt":$n[8].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].Text,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFillAmount","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFillAmount","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlexibleSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].LayoutElement,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOFlexibleSize","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].LayoutElement,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Image,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[9].Sequence,"p":[$n[2].Image,pc.ColorGradient,$n[0].Single]},{"a":2,"n":"DOHorizontalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOHorizontalNormalizedPos","rt":$n[9].Tweener,"p":[$n[2].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOJumpAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJumpAnchorPos","rt":$n[9].Sequence,"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMinSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].LayoutElement,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMinSize","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].LayoutElement,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DONormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].ScrollRect,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DONormalizedPos","rt":$n[9].Tweener,"p":[$n[2].ScrollRect,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPivot","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivot","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single]},{"a":2,"n":"DOPivotX","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotX","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPivotY","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotY","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPreferredSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].LayoutElement,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOPreferredSize","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].LayoutElement,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPunchAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"punch","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"elasticity","dv":1.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOPunchAnchorPos","rt":$n[9].Tweener,"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOScale","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Outline,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOScale","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Outline,$n[3].Vector2,$n[0].Single]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","dv":100.0,"o":true,"pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[9].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos","rt":$n[9].Tweener,"p":[$n[3].RectTransform,$n[0].Single,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[9].ShakeRandomnessMode]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","pt":$n[3].Vector2,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[9].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos$1","rt":$n[9].Tweener,"p":[$n[3].RectTransform,$n[0].Single,$n[3].Vector2,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[9].ShakeRandomnessMode]},{"a":2,"n":"DOShapeCircle","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"center","pt":$n[3].Vector2,"ps":1},{"n":"endValueDegrees","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"relativeCenter","dv":false,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOShapeCircle","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Single,$n[0].Boolean,$n[0].Boolean]},{"a":2,"n":"DOSizeDelta","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].RectTransform,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOSizeDelta","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].RectTransform,$n[3].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOText","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Text,"ps":0},{"n":"endValue","pt":$n[0].String,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"richTextEnabled","dv":true,"o":true,"pt":$n[0].Boolean,"ps":3},{"n":"scrambleMode","dv":0,"o":true,"pt":$n[9].ScrambleMode,"ps":4},{"n":"scrambleChars","dv":null,"o":true,"pt":$n[0].String,"ps":5}],"sn":"DOText","rt":$n[8].TweenerCore$3(System.String,System.String,DG.Tweening.Plugins.Options.StringOptions),"p":[$n[2].Text,$n[0].String,$n[0].Single,$n[0].Boolean,$n[9].ScrambleMode,$n[0].String]},{"a":2,"n":"DOValue","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Slider,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOValue","rt":$n[8].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].Slider,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOVerticalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOVerticalNormalizedPos","rt":$n[9].Tweener,"p":[$n[2].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUI end.*/

    /*DG.Tweening.DOTweenModuleUI+Utils start.*/
    $m("DG.Tweening.DOTweenModuleUI.Utils", function () { return {"td":$n[9].DOTweenModuleUI,"att":1048962,"a":2,"s":true,"m":[{"a":2,"n":"SwitchToRectTransform","is":true,"t":8,"pi":[{"n":"from","pt":$n[3].RectTransform,"ps":0},{"n":"to","pt":$n[3].RectTransform,"ps":1}],"sn":"SwitchToRectTransform","rt":$n[3].Vector2,"p":[$n[3].RectTransform,$n[3].RectTransform]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUI+Utils end.*/

    /*DG.Tweening.DOTweenModuleUnityVersion start.*/
    $m("DG.Tweening.DOTweenModuleUnityVersion", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Material,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[9].Sequence,"p":[$n[3].Material,pc.ColorGradient,$n[0].Single]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Material,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"property","pt":$n[0].String,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3}],"sn":"DOGradientColor$1","rt":$n[9].Sequence,"p":[$n[3].Material,pc.ColorGradient,$n[0].String,$n[0].Single]},{"a":2,"n":"DOOffset","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Material,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"propertyID","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3}],"sn":"DOOffset","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Material,$n[3].Vector2,$n[0].Int32,$n[0].Single]},{"a":2,"n":"DOTiling","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Material,"ps":0},{"n":"endValue","pt":$n[3].Vector2,"ps":1},{"n":"propertyID","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3}],"sn":"DOTiling","rt":$n[8].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[3].Material,$n[3].Vector2,$n[0].Int32,$n[0].Single]},{"a":2,"n":"WaitForCompletion","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":1}],"sn":"WaitForCompletion","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Boolean]},{"a":2,"n":"WaitForElapsedLoops","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"elapsedLoops","pt":$n[0].Int32,"ps":1},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":2}],"sn":"WaitForElapsedLoops","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Int32,$n[0].Boolean]},{"a":2,"n":"WaitForKill","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":1}],"sn":"WaitForKill","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Boolean]},{"a":2,"n":"WaitForPosition","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"position","pt":$n[0].Single,"ps":1},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":2}],"sn":"WaitForPosition","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"WaitForRewind","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":1}],"sn":"WaitForRewind","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Boolean]},{"a":2,"n":"WaitForStart","is":true,"t":8,"pi":[{"n":"t","pt":$n[9].Tween,"ps":0},{"n":"returnCustomYieldInstruction","pt":$n[0].Boolean,"ps":1}],"sn":"WaitForStart","rt":$n[3].CustomYieldInstruction,"p":[$n[9].Tween,$n[0].Boolean]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUnityVersion end.*/
    ...
    /*DG.Tweening.DOTweenModuleUtils+Physics start.*/
    $m("DG.Tweening.DOTweenModuleUtils.Physics", function () { return {"td":$n[9].DOTweenModuleUtils,"att":1048962,"a":2,"s":true,"m":[{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"CreateDOTweenPathTween","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].MonoBehaviour,"ps":0},{"n":"tweenRigidbody","pt":$n[0].Boolean,"ps":1},{"n":"isLocal","pt":$n[0].Boolean,"ps":2},{"n":"path","pt":$n[10].Path,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"pathMode","pt":$n[9].PathMode,"ps":5}],"sn":"CreateDOTweenPathTween","rt":$n[8].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[3].MonoBehaviour,$n[0].Boolean,$n[0].Boolean,$n[10].Path,$n[0].Single,$n[9].PathMode]},{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"HasRigidbody","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Component,"ps":0}],"sn":"HasRigidbody","rt":$n[0].Boolean,"p":[$n[3].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"HasRigidbody2D","is":true,"t":8,"pi":[{"n":"target","pt":$n[3].Component,"ps":0}],"sn":"HasRigidbody2D","rt":$n[0].Boolean,"p":[$n[3].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"SetOrientationOnPath","is":true,"t":8,"pi":[{"n":"options","pt":$n[12].PathOptions,"ps":0},{"n":"t","pt":$n[9].Tween,"ps":1},{"n":"newRot","pt":$n[3].Quaternion,"ps":2},{"n":"trans","pt":$n[3].Transform,"ps":3}],"sn":"SetOrientationOnPath","rt":$n[0].Void,"p":[$n[12].PathOptions,$n[9].Tween,$n[3].Quaternion,$n[3].Transform]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUtils+Physics end.*/
