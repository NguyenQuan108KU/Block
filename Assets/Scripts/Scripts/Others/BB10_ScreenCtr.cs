...
public class BB10_ScreenCtr : MonoBehaviour
{
    ...
    IEnumerator MovePart(Transform part, Vector2 target, float duration)
    {
    ...
    IEnumerator StartFade(GameObject obj, Vector2 startPos, Vector2 targetPos, bool enableGrid)
    {
        obj.SetActive(true);
