...
public class BB10_Grid : MonoBehaviour
{
    ...
    public void CheckGridFillTest(List<BB10_BrickCubeUnit> listUnit, int mainRow, int mainCol, BB10_ColorData data)
    {
        for (int col = 0; col < numberCol; col++)
        {
...
//                Debug.Log("run 11");
    ...
    public void ChangeSpriteFillCol(int col, BB10_ColorData data)
    {
        for (int row = 0; row < numberRow; row++)
        {
    ...
    public void ChangeSpriteFillRow(int row, BB10_ColorData data)
    {
        for (int col = 0; col < numberCol; ++col)
        {
            if (grid[row, col] != null)
