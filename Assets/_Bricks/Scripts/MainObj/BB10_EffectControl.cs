...
public class BB10_EffectController
{
    ...
    public static IEnumerator FadeIn(Transform obj, float duration)
    {
        ...
        while (elapsed <= duration)
        {
            mat.SetFloat("_alpha", elapsed / duration);
            elapsed += Time.deltaTime;
            yield return null;
        }
    ...
    public static IEnumerator FadeOut(Transform obj, float duration)
    {
        ...
        while (elapsed <= duration)
        {
            mat.SetFloat("_alpha", 1 - elapsed / duration);
            elapsed += Time.deltaTime;
            yield return null;
        }
    ...
    public static IEnumerator FadeOutSprite(GameObject obj, float duration)
    {
        ...
        {
            elapsed += Time.deltaTime;
            render.color = new Color(color.r, color.g, color.b, 1 - elapsed / duration);
            yield return null;
        }
